  ...
  return (
    <>
      <SEO 
        ...
        description="Create professional GST-compliant invoices instantly with Invoice Port. Free invoice generator for Indian businesses, freelancers & startups. Customizable templates, PDF export, email delivery & client management. Start free today!"
      ...
      <div className="relative z-10 flex flex-col lg:flex-row items-center justify-center max-w-7xl mx-auto px-6 py-16 lg:py-24 gap-16 lg:gap-24 min-h-[80vh]">
          ...
          <div className="w-full lg:w-1/2 text-center lg:text-left space-y-8">
              ...
              <p className="text-lg text-slate-400 max-w-xl mx-auto lg:mx-0 leading-relaxed">
                  Create professional GST-compliant invoices instantly. Perfect for Indian businesses, freelancers & startups. Free templates, email delivery & client management.
              </p>
